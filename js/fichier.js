...
function listIngredient(recipe) {
    ...
    recipe.ingredients.forEach(function (ingredientOfRecipe) {
        var ingredient = ingredientOfRecipe.ingredient;
...
function isSearchInRecipe(recipe, valueSearch) {
    ...
    if (rightTagIngredient) {
        ...
        arrayIngredient.forEach(function (ingredientOfRecipe) {
            var ingredient = ingredientOfRecipe.ingredient.toLowerCase().trim();
